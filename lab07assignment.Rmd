...
> **1.** Create a scatterplot of total rating (`rating`) versus flavor grade (`flavor`). Remember that total rating will be the response variable throughout this analysis. Be sure to include appropriate axis labels and an appropriate title. Using the scatterplot, briefly comment on the relationship (in terms of strength, direction, form, and outliers). 
...
> **2.** Create a scatterplot of total rating (`rating`) versus body grade (`body`). Remember that total rating will be the response variable throughout this analysis. Be sure to include appropriate axis labels and an appropriate title. Using the scatterplot, briefly comment on the relationship (in terms of strength, direction, form, and outliers). 
...
3. In the Files pane (bottom right window), check the box next to `lab07assignment.html`. 

4. In the Files pane, click on the gear icon (More) and select "Export..."  

5. Do not change the file name (`lab07assignment.html`). Click Download and save the file to your computer. 

6. On the Stats 250 Canvas site, navigate to the Lab 7 assignment. 

7. Upload your saved `lab07assignment.html` file. 

8. Click "Submit Assignment". Congratulations, you are done with Lab 7!
