...
**Demo #6:** Using the stored linear model for the cereal analysis, create the residual plot and the QQ plot of the residuals.  
...
That's it for Lab 7! Click on the file titled `lab07assignment.Rmd` in the bottom right window to open up the lab assignment. Please do not hesitate to ask questions! 
